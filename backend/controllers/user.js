...
module.exports.signUp = async (req, res, next) => {
    ...
    await profileModel.insertOne({ userInfo: newUser._id });
...
module.exports.getProfileInfo = async (req, res) => {
    ...
    try {
        const profileInfo = await profileModel.findOne({ userInfo: id }).populate({ path: 'userInfo', select: 'email username phone', populate: { path: 'reviews', model: 'review' } });
