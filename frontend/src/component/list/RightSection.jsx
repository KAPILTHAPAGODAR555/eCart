...
function RightSection({description , img , heading}) {
  return (
    <div className='container mt-5 p-2'>
        ...
        <div className='row'>
            <div className='col-12 col-md-12 col-lg-7 mt-3 text-center d-flex flex-column align-items-center justify-content-center'>
                ...
                <Button variant='outlined' className='mt-3 mb-3 w-50 p-2'>Read More</Button>
            </div>
            <div className='col-12 col-md-12 col-lg-1'></div>
            <div className='col-12 col-md-12 col-lg-4 p-3'>
                <img src={img} style={{borderRadius: '10px' , width: '100%' , height: '100%'}}></img>
            </div>
