  ...
  return (
    <div className='container flex-grow-1 p-2'>
      <Nav />
       ...
       <LeftSection img={'/root.png'} heading="Our Roots and Inspiration" description="We are a passionate team of plant lovers and tech enthusiasts based 
        in the heart of Jalandhar, Punjab. Our journey began with a simple idea: to make the joy of plant..."/>
        <RightSection img={'/values.png'} heading = "Our Values and Commitment" description = "At eCart, we believe in the power of a single plant to transform a space and uplift a spirit. Our core values are quality, accessibility, and community.We are committed to sourcing only the healthiest...."/>
        <LeftSection img={'/product.png'} heading="Our Products and Expertise" description="We’re not just a marketplace; we're your partner in gardening. Our app offers a carefully curated selection of plants, from low-maintenance succulents and air-purifying indoor plants to vibrant flowering varieties..."/>
        <RightSection img={'/connect.png'} heading="Our Connection to Jalandhar and Punjab" description="Being based in Jalandhar, Punjab, is an integral part of our story. We are proud to operate from a region known for its strong agricultural roots and entrepreneurial spirit. We draw inspiration from the fertile land and dedicated farmers of Punjab..." />
